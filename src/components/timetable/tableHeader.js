...
const TableHeader = props => (
  <div
    className={classNames(styles.root, {
      [styles.largeText]: props.printingAsA4,
    })}>
    <div className={classNames(styles.title, { [styles.largeText]: props.printingAsA4 })}>
      <span className={styles.strong}>{props.title}</span>
      &nbsp;&nbsp;
      {props.subtitle}
    </div>

    <div className={classNames(styles.subtitle, { [styles.largeText]: props.printingAsA4 })}>
